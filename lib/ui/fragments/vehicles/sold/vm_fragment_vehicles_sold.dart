...
class VmFragmentVehicleSold extends ViewModelBase {
  VmFragmentVehicleSold(this.serviceApi, this.orderByField, this.orderByDirection) {
  ...
  Future<void> getDataScrollable([bool isPagination = true]) async {
    ...
    notifyListeners();
    await serviceApi.client.getVehiclesSales(start: page, length: take, search: searchController.text).then(
      (response) {
