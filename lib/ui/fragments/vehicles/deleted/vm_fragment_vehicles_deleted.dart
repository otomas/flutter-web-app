...
class VmFragmentVehicleDeleted extends ViewModelBase {
  VmFragmentVehicleDeleted(this.serviceApi, this.orderByField, this.orderByDirection) {
  ...
  Future<void> getDataScrollable([bool isPagination = true]) async {
    ...
    notifyListeners();
    await serviceApi.client.getVehiclesDeleted(start: page, length: take, search: searchController.text).then(
      (response) {
