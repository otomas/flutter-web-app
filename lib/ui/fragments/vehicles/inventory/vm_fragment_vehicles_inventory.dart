...
class VmFragmentVehicleInventory extends ViewModelBase {
  VmFragmentVehicleInventory(this.serviceApi, this.orderByField, this.orderByDirection) {
  ...
  Future<void> getDataScrollable([bool isPagination = true]) async {
    ...
    notifyListeners();
    await serviceApi.client.getVehiclesInventory(start: page, length: take, search: searchController.text).then(
      (response) {
