...
import 'vm_fragment_vehicle_detail_query_kilometer.dart';

@RoutePage()
class FragmentVehicleDetailQueryKilometer extends StatefulWidget {
  const FragmentVehicleDetailQueryKilometer({
  ...
  @override
  State<FragmentVehicleDetailQueryKilometer> createState() => _FragmentVehicleDetailQueryKilometerState();
}

class _FragmentVehicleDetailQueryKilometerState extends WidgetBaseStatefull<FragmentVehicleDetailQueryKilometer, VmFragmentVehicleDetailQueryKilometer> {
  @override
  SystemUiOverlayStyle systemBarBrightness() => UIBrightnessStyle.getInstance().system();

  @override
  VmFragmentVehicleDetailQueryKilometer createViewModel(BuildContext context) => VmFragmentVehicleDetailQueryKilometer(apiService(context), widget.id);

  @override
  Widget buildWidget(BuildContext context, VmFragmentVehicleDetailQueryKilometer viewModel) => Container(
        margin: const EdgeInsets.symmetric(vertical: 40),
        child: WidgetVehicleDetailCard(
          title: 'Kilometre Kaydı',
  ...
  @override
  Widget buildWidgetForWeb(BuildContext context, VmFragmentVehicleDetailQueryKilometer viewModel) => buildWidget(context, viewModel);

  Widget _getVehicleInfo(BuildContext context, VmFragmentVehicleDetailQueryKilometer viewModel) => WidgetVehicleDetailBar(
  ...
  Widget _getQueryTypeSelection(BuildContext context, VmFragmentVehicleDetailQueryKilometer viewModel) => WidgetFlexible(
        isRow: isWeb(context),
  ...
  Widget _getQueries(BuildContext context, VmFragmentVehicleDetailQueryKilometer viewModel) => Container(
        width: size(context).width,
        padding: const EdgeInsets.all(20),
        child: viewModel.data.isEmpty
            ? const WidgetEmptyView(
                isExpanded: false,
                title: 'Geçmiş kilometre sorgunuz bulunmamaktadır.',
              )
            : Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            RichTextBasic(
              ...
              texts: 'Geçmiş Kilometre Sorgularınız'.highlightOccurrences(
                'Kilometre',
