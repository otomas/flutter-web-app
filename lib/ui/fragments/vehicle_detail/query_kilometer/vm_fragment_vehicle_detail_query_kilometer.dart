...
class VmFragmentVehicleDetailQueryKilometer extends ViewModelBase {
  VmFragmentVehicleDetailQueryKilometer(this.serviceApi, this.vehicleId) {
  ...
  Future<void> getData() async {
    await serviceApi.client.getVehicleKilometerRecords(vehicleId).then(
      (response) {
        data = response.data ?? [];
      },
      onError: (error) {
