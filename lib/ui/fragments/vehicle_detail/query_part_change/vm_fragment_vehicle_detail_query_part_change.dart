...
class VmFragmentVehicleDetailQueryPartChange extends ViewModelBase {
  VmFragmentVehicleDetailQueryPartChange(this.serviceApi, this.vehicleId) {
  ...
  Future<void> getData() async {
    await serviceApi.client.getVehiclePartChangeRecords(vehicleId).then(
      (response) {
        data = response.data ?? [];
      },
      onError: (error) {
